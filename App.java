...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    do {
      ...
      try {
        ...
        // If the file name is not valid, print an error message and set the flag to true
    ...
    if (!sc.nextLine().equals("</AUTOSAR>")) {
      throw new DefAutosarFileException(file);
    }
  ...
  class Func {
     ...
     * @throws NotVaildAutosarFileException If the file name does not have a valid .arxml extension
     */
    ...
    public static String[] get_1stLines(Scanner sc, File f)
      throws DefAutosarFileException {
      // Read the first two lines of the file
      String[] l = { sc.nextLine(), sc.nextLine() };

      // Check if the first line starts with "<?xml version=", contains " encoding=", and ends with "?>"
      // and if the second line equals "<AUTOSAR>"
      if (
        l[0].startsWith("<?xml version=") &&
        ...
        throw new DefAutosarFileException(f);
      }
    }
