...
public class Container implements Comparable<Container> {
   ...
   */
  public Container(Scanner sc, File f) throws DefAutosarFileException {
    // Read the first line and check if it starts with "<CONTAINER UUID=" and ends with ">"
    ...
    // Read the next line and check if it starts with "<SHORT-NAME>" and ends with "</SHORT-NAME>"
    Line = sc.nextLine();
    ...
    // Read the next line and check if it starts with "<LONG-NAME>" and ends with "</LONG-NAME>"
    Line = sc.nextLine();
